        ...
        <div className="w-full h-full flex">
            <div className="grow shrink basis-0 self-stretch p-10 bg-BG-800 border-zinc-800 flex-col justify-between flex">
                <div className="justify-start items-center gap-2 inline-flex">
                    <h2 className="text-white text-[25px] font-bold leading-7 flex gap-1"> <Popcorn />  Star Movies</h2>
                </div>
                <div className="self-stretch h-28">
                    <p className="self-stretch text-white text-lg font-normal leading-7">Cillum dolore sint labore commodo aute dolore cupidatat labore esse. Consectetur pariatur veniam in dolor ullamco ex elit eu fugiat voluptate elit do esse laborum.</p>
                    <a className="text-white text-sm font-normal leading-tight" target="_blank" href="#">Rocketseat</a>
                </div>
            </div>
